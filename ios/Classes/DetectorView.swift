...
class DetectorView: NSObject, FlutterPlatformView, FlutterStreamHandler {
    ...
    private func configureHelper() {
        ...
        cameraHelper = VouchedCameraHelper(with: CardDetect.self, detectionOptions: [.cardDetect(CardDetectOptionsBuilder().withEnableDistanceCheck(false).build())], in: previewView)?.withCapture(
            delegate: {
